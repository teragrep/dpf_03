...
public abstract class MapBuffer<T> implements Serializable {
    ...
    public void setMap(Map<T, Integer> list) {
        this.map = list;
    }
    ...
    public abstract void mergeMap(Map<T, Integer> another);
